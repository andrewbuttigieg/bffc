				...
				<div id="wppa_table_4" style="display:none" >
					<table class="widefat wppa-table wppa-setting-table">
						...
						wppa_setting_subheader( 'B', '1', __( 'Slideshow related settings' , 'wp-photo-album-plus') );
							...
							wppa_setting($slug, '15', $name, $desc, $html, $help, $clas, $tags);
/*
							$name = __('Sutcliffe style');
							$desc = __('Show description with counter at limited size.', 'wp-photo-album-plus');
							$help = '';
							$slug = 'wppa_sutcliffe';
							$opts = array(	__('--- none ---', 'wp-photo-album-plus'),
											__('available width', 'wp-photo-album-plus'),
											__('width of image', 'wp-photo-album-plus'),
											__('width of portrait image', 'wp-photo-album-plus'),
											);
							$vals = array(	'none',
											'fullsize',
											'imagewidth',
...
*/
						...
						wppa_setting_subheader( 'F', '1', __( 'Watermark related settings' , 'wp-photo-album-plus') );
							...
							$html .= '<img id="img_wppa_watermark_file" src="'.wppa_get_imgdir().'star.ico" title="'.__('Setting unmodified', 'wp-photo-album-plus').'" style="padding-left:4px; float:left; height:16px; width:16px;" />';
							...
							$html .= '<img id="img_wppa_watermark_pos" src="'.wppa_get_imgdir().'star.ico" title="'.__('Setting unmodified', 'wp-photo-album-plus').'" style="padding-left:4px; float:left; height:16px; width:16px;" />';
							$clas = 'wppa_watermark';
							$tags = 'water';
							wppa_setting(false, '3', $name, $desc, $html, $help, $clas, $tags);
